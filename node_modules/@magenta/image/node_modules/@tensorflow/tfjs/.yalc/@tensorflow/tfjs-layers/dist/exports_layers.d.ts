...
import { ELULayerConfig, LeakyReLULayerConfig, ReLULayerConfig, SoftmaxLayerConfig, ThresholdedReLULayerConfig, PReLULayerConfig } from './layers/advanced_activations';
...
export declare function prelu(config?: PReLULayerConfig): Layer;

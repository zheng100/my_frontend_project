...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function fitDataset(model, dataset, config) {
        return __awaiter(this, void 0, void 0, function () {
            var hasBatchesPerEpoch, doValidation, valXs, valYs, validationData, trainFunction, outLabels, callbackMetrics, callbacks, _a, callbackList, history_1, epoch, dataIterator, epochLogs, stepsDone, batchIndex, iteratorOut, xsAndYs, batchLogs, outs, i, label, out, valOuts, _b, i;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4:
                        if (!(epoch < config.epochs)) return [3, 19];
                        epochLogs = {};
                    ...
                    case 6:
                        ...
                        _c.label = 7;
                    case 7:
                        if (!(hasBatchesPerEpoch ? stepsDone < config.batchesPerEpoch : true)) return [3, 17];
    ...
    var PReLU = (function (_super) {
        ...
        function PReLU(config) {
            ...
            _this.supportsMasking = true;
            _this.alphaInitializer = getInitializer(config.alphaInitializer || _this.DEFAULT_ALPHA_INITIALIZER);
            _this.alphaRegularizer = getRegularizer(config.alphaRegularizer);
            _this.alphaConstraint = getConstraint(config.alphaConstraint);
            if (config.sharedAxes == null) {
                _this.sharedAxes = null;
            }
            else if (Array.isArray(config.sharedAxes)) {
                _this.sharedAxes = config.sharedAxes;
            }
    ...
    var Embedding = (function (_super) {
        ...
        function Embedding(config) {
            ...
            _this.supportsMasking = config.maskZero;
            ...
            var _loop_1 = function (t) {
                ...
                if (mask == null) {
                    ...
                    var maskedOutputs = tfc.tidy(function () {
                        ...
                        var output = stepOutputs[0].mul(stepMask)
    ...
    var RNN = (function (_super) {
        ...
        Object.defineProperty(RNN.prototype, "states", {
            get: function () {
                if (this.states_ == null) {
                    var numStates = Array.isArray(this.cell.stateSize) ?
